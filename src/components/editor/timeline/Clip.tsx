...
export const Clip: React.FC<ClipProps> = ({ clip, mediaAsset, pixelsPerSecond, selected }) => {
  ...
  const getClipColor = () => {
    ...
    return 'bg-[#0b525d] border-[#5ad5e4]/55'
  }
  ...
  return (
    <div
      ...
      className={`absolute h-full cursor-grab active:cursor-grabbing rounded-sm overflow-hidden transition-colors border ${
    ...
    >
      ...
      <div className="w-full h-full px-1 py-1 flex flex-col gap-1 overflow-hidden">
        <div className="h-6 px-2 rounded-[3px] bg-[#07515c] border border-[#6ad8e5]/40 flex items-center gap-3">
